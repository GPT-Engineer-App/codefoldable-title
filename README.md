...
**Project**: codefoldable-title 

**URL**: https://run.gptengineer.app/projects/REPLACE_WITH_PROJECT_ID/improve

**Description**: A collapsible code block with the filename as a title. The codeblock is interleaved in an article with normal text in dark mode. 
...
```sh
git clone https://github.com/GPT-Engineer-App/codefoldable-title.git
cd codefoldable-title
npm i
